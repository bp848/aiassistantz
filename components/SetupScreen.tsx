    ...
    <div className="min-h-[100dvh] bg-[#0F172A] flex flex-col items-center justify-center p-4 text-gray-100 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg flex flex-col items-center z-10 animate-fadeIn">
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-500 text-xs mt-4 max-w-sm mx-auto font-medium text-gray-400">
            操作手順
          </p>
          <ol className="list-decimal list-inside text-gray-500 text-xs mt-1 max-w-sm mx-auto space-y-0.5">
            <li>下のボタンで使いたいモードを1つ選ぶ</li>
            <li>選ぶとその場で秘書との会話が始まります</li>
          </ol>
        </div>
